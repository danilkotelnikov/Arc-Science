...
- [S0 record, 2026-09-25](2026-09-25-s0-prototype-record.md): the Blockprint prototype on HeroUI v3 (eight palettes, RU/EN, HSE Sans from the installed copy), the logo exploration on a continuous-corner tile, and the review rounds; awaiting the operator's visual approval.
