# Arc Science product gates

User intent: a fast local native Rust desktop research workbench, developed through
HoH, with usable molecular figures, evidence-bound decision routes, reliable session
memory and scientifically defensible outputs. Existing Python scientific workers
and compiled web UI remain components of the native Rust host; there is no authorized
reason to replace validated numerical code merely to claim a language rewrite.
...
qualified, regardless of the number of local passing tests.
