...
Утверждения задания, каждое суженное до того, что подтверждают доказательства:

![Область утверждений завершённого задания](docs/images/claims-ru.png)
...
![Рабочая среда в палитре «Тёмная академия»](docs/images/research-dark.png)
