...
const env = {
  ...
  ARC_MEMORY_WORKER: optional(resolve(root, 'native/arc-memory/target/release/arc-memory-worker.exe')),
  ARC_SVG2PNG: optional(resolve(root, 'native/arc-svg/target/release/arc-svg2png.exe')),
};
